...
savenames = ["Fig_fixed_depth_MC_fixed_diameter2.png", "Fig_fixed_depth_MC_geophysical2.png"]

# figure resolution
DPI = 400  # Set resolution for saving figures

x_vars = ["T_grad_m", "p_frac_grad", "p_hydro_grad", "m_dot", "r_f"]
x_labels = ["Temperature\nGradient\n(deg C/km)", "Fracture\nPressure\nGradient\n(MPa/km)", "Hydrostatic\nPressure\nGradient\n(MPa/km)",
            "Mass\nFlow Rate\n(kg/s)", "Formation\nradius\n(m)"]
x_converts = [1000.0, 1.0, 1.0, 1.0, 1.0]
x_limits = [[], [], [], [], []]
