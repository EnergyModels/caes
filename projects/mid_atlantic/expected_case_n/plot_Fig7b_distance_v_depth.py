...
# Main plot
sns.scatterplot(data=df, x='Distance to shore (km)', y='Water depth (m)', hue='Nearest State (-)',
                style='Formation (-)', style_order=['Middle Cretaceous', 'Lower Cretaceous',  'Upper Jurassic'], ax=a)

a.set_xlim(left=0.0, right=100.0)
a.set_ylim(top=0, bottom=-60.0)
# a.set_yscale('symlog')
...
a.legend(bbox_to_anchor=(1.025, 0.5), loc="center left", ncol=1)
...
plt.tight_layout()
# save
plt.savefig('Fig7b_Distance_v_Depth.png', dpi=300)
