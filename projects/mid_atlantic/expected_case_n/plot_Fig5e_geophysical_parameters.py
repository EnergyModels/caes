...
savename = "Fig5e_geophysical_parameters.png"
...
palette_rgb = np.array([[215, 48, 39],
                        [252, 141, 89],
                        [254, 224, 144],
                        [255, 255, 191],
                        [224, 243, 248],
...
boundaries = [10, 20, 30, 40, 50, 60]#, 100]
norm = colors.BoundaryNorm(boundaries, cmap.N, extend='both')#, clip=True)
...
for j, (y_var, y_label, y_convert, y_limit, y_scale) in enumerate(
    ...
    for i, (formation) in enumerate(df.sheet_name.unique()):
        ...
        # plot
        im = ax.scatter(x, y, c=c, s=markersize, marker='.', cmap=cmap, norm=norm)
